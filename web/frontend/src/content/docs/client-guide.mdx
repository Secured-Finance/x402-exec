...
<CodeTabs
  codes={{
    npm: "npm install @secured-finance/client @secured-finance/core viem",
    pnpm: "pnpm add @secured-finance/client @secured-finance/core viem",
    yarn: "yarn add @secured-finance/client @secured-finance/core viem",
    bun: "bun add @secured-finance/client @secured-finance/core viem",
  }}
  lang="bash"
/>

...
<CodeTabs
  codes={{
    npm: "npm install @sf-x402/client @sf-x402/core viem",
    pnpm: "pnpm add @sf-x402/client @sf-x402/core viem",
    yarn: "yarn add @sf-x402/client @sf-x402/core viem",
    bun: "bun add @sf-x402/client @sf-x402/core viem",
  }}
  lang="bash"
/>

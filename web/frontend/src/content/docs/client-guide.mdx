...
<CodeTabs
  codes={{
    npm: "npm install @secured-finance/x402-client @secured-finance/x402-core viem",
    pnpm: "pnpm add @secured-finance/x402-client @secured-finance/x402-core viem",
    yarn: "yarn add @secured-finance/x402-client @secured-finance/x402-core viem",
    bun: "bun add @secured-finance/x402-client @secured-finance/x402-core viem",
  }}
  lang="bash"
/>

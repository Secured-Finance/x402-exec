...
```typescript
import type { X402MiddlewareOptions } from "@sf-x402/hono";
...
- [`@sf-x402/express`](../express): Express middleware
- [`@sf-x402/fetch`](../fetch): Fetch wrapper for clients
- [`@sf-x402/react`](../react): React hooks

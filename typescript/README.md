...
- **[@secured-finance/x402-core](./packages/core)**: Core utilities, types, and helper functions
- **[@secured-finance/x402-fetch](./packages/fetch)**: Fetch wrapper for automatic 402 handling with settlement support
- **[@secured-finance/x402-express](./packages/express)**: Express middleware for creating 402 payment gates
- **[@secured-finance/x402-hono](./packages/hono)**: Hono middleware for creating 402 payment gates
- **[@secured-finance/x402-react](./packages/react)**: React hooks for payment integration
...
```bash
npm install @secured-finance/x402-express @secured-finance/x402-core
```

```typescript
import express from 'express';
import { x402Middleware } from '@secured-finance/x402-express';
...
```bash
npm install @secured-finance/x402-react
```
...
```typescript
import { isSettlementMode, settleWithRouter } from '@secured-finance/x402-core';
...
### ✨ Core Features (@secured-finance/x402-core)
...
### 🔄 Fetch Wrapper (@secured-finance/x402-fetch)
...
### 🌐 Server Middleware (@secured-finance/x402-express, @secured-finance/x402-hono)
...
- ⚡ **Edge Runtime**: @secured-finance/x402-hono supports edge deployments

### ⚛️ React Integration (@secured-finance/x402-react)
...
│                         Client                               │
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐      │
│  │ @secured-finance/x402-react │  │ @secured-finance/x402-fetch │  │   Native     │      │
│  │    Hooks     │─▶│    Wrapper   │─▶│    Fetch     │      │
│  └──────────────┘  └──────────────┘  └──────────────┘      │
│                           │                                  │
│                           │ Uses                             │
...
│                    Resource Server                           │
│  ┌────────────────────┐         ┌────────────────────┐      │
│  │  @secured-finance/x402-express    │   OR    │   @secured-finance/x402-hono      │      │
...
│                       Facilitator                            │
│  ┌──────────────────────────────────────────────────────┐   │
│  │              @secured-finance/x402-core Utilities                   │   │
│  │  • isSettlementMode                                  │   │
│  │  • settleWithRouter                                  │   │
...
4. **Flexible Deployment**: Edge runtimes can use @secured-finance/x402-hono without Node.js dependencies
...
```bash
# From project root
pnpm --filter @secured-finance/x402-core run build
pnpm --filter @secured-finance/x402-fetch run build

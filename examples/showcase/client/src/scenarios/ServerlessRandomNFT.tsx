...
import { NFTMintHook } from "@sf-x402/core";
  ...
  return (
    <ScenarioCard
      ...
      description={
        <>
          <p>
            Pay <strong>$0.1 USDC</strong> and automatically mint a random NFT. Your USDC returns to
            your wallet!
          </p>
                    ...
                    <tr key={network} style={{ borderBottom: "1px solid #fed7aa" }}>
                      ...
                      >
                        {data.loading
                          ...
                          : data.error
                            ? "-"
                            : data.remainingSupply.toLocaleString()}
                      </td>
          ...
          <CodeBlock code={nftMintCode} title="🔧 Technical Flow:" borderColor="#28a745" />
        </>
      }
    >
